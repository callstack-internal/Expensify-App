...
/**
 * Add-expense branch of the report preview action button. Owns the add-expense-only subscriptions (billing grace
 * periods, amount owed, draft transactions, last distance type) and lazy icons so they only load while this branch
 * is mounted, and reads its subject data from context.
 */
