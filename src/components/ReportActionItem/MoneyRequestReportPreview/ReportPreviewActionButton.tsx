...
/**
 * Dispatches to the correct action button for the money request report preview. Owns no data: it reads the decision
 * (which branch to render) and the button width from context, and each branch is a self-contained context consumer.
 */
