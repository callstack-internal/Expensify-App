 ...
 *
 * Separate instance from `TransactionThread`'s. Identical shape; chat-report subtree
 * must not subscribe to a provider mounted in a different compound.
 *
...
ReplyContextProvider.displayName = 'ChatReport.ReplyContextProvider';
