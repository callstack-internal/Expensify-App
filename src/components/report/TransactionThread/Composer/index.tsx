...
import {useReply} from '@components/report/TransactionThread/ReplyContextProvider/ReplyContext';
 ...
 * semantics today's `ReportScreen` provides for transaction-thread reports — losing
 * those would regress the visible UX, which Issue 02 is not allowed to do.
 *
...
Composer.displayName = 'TransactionThread.Composer';
