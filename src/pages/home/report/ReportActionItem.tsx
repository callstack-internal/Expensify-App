...
function ReportActionItem({allReports, policies, action, report, transactions, shouldShowDraftMessage = true, userWallet, isUserValidated, personalDetails, ...props}: ReportActionItemProps) {
    ...
    console.log('emojiReactions', emojiReactions);
    console.log('linkedTransactionRouteError', linkedTransactionRouteError);
