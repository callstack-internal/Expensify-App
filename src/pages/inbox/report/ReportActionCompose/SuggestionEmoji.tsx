...
function SuggestionEmoji({
     ...
     */
    function insertSelectedEmoji(highlightedEmojiIndexInner: number) {
     ...
     */
    function calculateEmojiSuggestion(newValue: string, selectionStart?: number, selectionEnd?: number) {
    ...
    function getSuggestions() {
        return suggestionValues.suggestedEmojis;
    }

    function getIsSuggestionsMenuVisible() {
        return isEmojiSuggestionsMenuVisible;
    }
