...
function ReportActionItem({
    ...
    const [originalReportRaw] = useOnyx(`${ONYXKEYS.COLLECTION.REPORT}${originalReportID}`);
    // Strip unnecessary fields so `originalReport` doesn't churn on every read/new-message event.
    const originalReport = useStableReportForReportActionItem(originalReportRaw);
