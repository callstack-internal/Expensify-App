 ...
 * instead of scanning the actions list with indexOf on every render.
 */
function getActionIndexMap(actions: OnyxTypes.ReportAction[]): Map<string, number> {
...
function ReportActionsListContent({reportID, onLayout}: ReportActionsListProps) {
    ...
    const getRenderedVisibleReportActions = () => {
    ...
    const renderedVisibleReportActions = getRenderedVisibleReportActions();
    ...
    const getActionBadgeTargetIndex = () => {
    ...
    const getShouldUseThreadDividerLine = () => {
    ...
    const shouldUseThreadDividerLine = getShouldUseThreadDividerLine();

    const actionIndexMap = getActionIndexMap(renderedVisibleReportActions);
